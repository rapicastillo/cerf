...

				{
					...
					[
...

						{
                            ...
                            ['Lightbox for Single Picture', 'lightbox[]'],
							
							['Lightbox for Single Video', 'lightvideo[]'],

							['Lightbox for Smugmug Gallery', 'lightframe[|width:800px; height:600px; scrolling: no;]'],
							
							['Lightbox for Smugmug Video', 'lightframe[|width:640px; height:360px; scrolling: no;]']
